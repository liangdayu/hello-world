...
[uninstalled] [4.2.0 ] wrapper           standard-4.2.0      Provide OS integration
[uninstalled] [4.2.0 ] obr               standard-4.2.0      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.2.0 ] config            standard-4.2.0      Provide OSGi ConfigAdmin support
[uninstalled] [4.2.0 ] region            standard-4.2.0      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.2.0      Provide Jetty engine support
[uninstalled] [4.2.0 ] http              standard-4.2.0      Implementation of the OSGI HTTP Service
[uninstalled] [4.2.0 ] http-whiteboard   standard-4.2.0      Provide HTTP Whiteboard pattern support
[uninstalled] [4.2.0 ] war               standard-4.2.0      Turn Karaf as a full WebContainer
[uninstalled] [4.2.0 ] deployers         standard-4.2.0      Provide Karaf deployer
[uninstalled] [4.2.0 ] kar               standard-4.2.0      Provide KAR (KARaf archive) support
[uninstalled] [4.2.0 ] webconsole-base   standard-4.2.0      Base support of the Karaf WebConsole
[uninstalled] [4.2.0 ] webconsole        standard-4.2.0      Karaf WebConsole for administration and monitoring
[uninstalled] [4.2.0 ] ssh               standard-4.2.0      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.2.0.war, and
